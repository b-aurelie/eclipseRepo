...
public class Fenetre1 extends JFrame implements ActionListener, KeyListener{
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource()==operationsBox)
			cb = (JComboBox)ae.getSource();
	
		if (ae.getSource()==boutonAdd) result = saisie1+saisie2;
		else if (ae.getSource()==boutonSous) result = saisie1-saisie2;
		else if (ae.getSource()==boutonMult) result = saisie1*saisie2;
		else if (ae.getSource()==boutonDiv) result = (float)saisie1/saisie2;
		else
			if ((String)cb.getSelectedItem()=="addition") result = saisie1+saisie2;
			else if ((String)cb.getSelectedItem()=="soustraction") result = saisie1-saisie2;
			else if ((String)cb.getSelectedItem()=="multiplication") result = saisie1*saisie2;
			else if ((String)cb.getSelectedItem()=="division")  result = (float)saisie1/saisie2;
